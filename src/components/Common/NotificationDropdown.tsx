      ...
      <div className="max-h-[320px] overflow-y-auto custom-scrollbar">
        {products.length === 0 ? (
          ...
          products.map((product) => (
            <div key={product.id} className="p-4 border-b border-white/[0.02] hover:bg-white/[0.02] transition-all group cursor-default">
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <div className="w-full h-[2px] bg-white/5 mt-2 rounded-full overflow-hidden">
                    <div 
                      ...
                      style={{ width: `${Math.min((product.stock / product.min_stock) * 100, 100)}%` }}
                    />
                  </div>
                </div>
              </div>
